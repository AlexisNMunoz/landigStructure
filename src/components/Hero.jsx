...
export default function Hero() {
    return (
        <section className="wrapper grid place-items-center md:grid-cols-2 gap-4 h-screen z-20">
            <div className="grid space-y-5 text-center max-w-[500px] ">
                ...
                <p className="text-slate-800 bg-white lg:bg-none lg:shadow-none p-2 rounded-md shadow-md md:text-xl md:text-left md:max-w-md lg:text-2xl">Dale rienda suelta a tu imaginación y nosotros la transformamos en código.</p>
